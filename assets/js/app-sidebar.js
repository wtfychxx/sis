...
$(document).ready(function () {
	...
	$(".nav-toggle").on("click", function () {
		...
		if (toggle === "expanded") {
			...
			$(".nav-toggle")
				.find(".toggle-icon")
				.removeClass("feather-toggle-right")
				.addClass("feather-toggle-left");
			...
			$(".nav-toggle")
				.find(".toggle-icon")
				.removeClass("feather-toggle-left")
				.addClass("feather-toggle-right");
	...
	$(window).resize(function () {
		...
		if ($(window).width() > 992) {
			...
			if (
				...
				$wrapper.not(".nav-collapsed menu-collapsed")
			) {
		...
		if (screenfull.enabled) {
			$(document).on(screenfull.raw.fullscreenchange, function () {
				if (screenfull.isFullscreen) {
					$(".apptogglefullscreen")
						.find("i")
						.toggleClass("feather-minimize feather-maximize");
				} else {
					$(".apptogglefullscreen")
						.find("i")
						.toggleClass("feather-maximize feather-minimize");
				}
			});
		}
	}
